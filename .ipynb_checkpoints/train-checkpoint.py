...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="gemini/pth/resnet50.pth", trainable_layers=3)
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='gemini/data-1', help='dataset')
    # 检测目标类别数(不包含背景)
